# data-directory-layout Specification

## Purpose
Defines the standard directory structure for all runtime data under `data/`, separating operational data from code and knowledge assets.
